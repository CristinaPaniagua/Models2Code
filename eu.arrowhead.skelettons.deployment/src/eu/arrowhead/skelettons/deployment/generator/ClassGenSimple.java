...
import eu.arrowhead.skelettons.deployment.common.CodgenUtil;
...
public class ClassGenSimple {
    ...
    .addModifiers(Modifier.PUBLIC);
     ...
     public  ArrayList<String> classGen ( ArrayList<String[]> elements , String className,String Directory, String foldername, String system){
